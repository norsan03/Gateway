  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        ...
        <a class="navbar-brand" href="ADMproductos.jsp">Wallapop TIW</a>
        </div>
    ...
    <nav class="navbar">
      ...
      <ol class="breadcrumb" style="background-color: #23C5B2; color: white">
        <li><a href="ADMusuarios.jsp" style="color: white"><b>Gestion Usuarios</b></a></li>
      </ol>
      ...
      <div class="row">
        ...
        <c:forEach items="${sessionScope.usuarios }" var="usuario">
	        ...
	        <div class="col-md-3 well">
	          ...
	          <h2>${usuario.email }</h2>
	          <a class="btn btn-info" style="background-color: #23C5B2" href="ADMusuarioESP.jsp" role="button">Detalles</a> 
